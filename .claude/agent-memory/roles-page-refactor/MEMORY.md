...
- [Roles 頁面當前真實結構](project_roles_page_structure.md) — 5 檔（2 個共用 Model 確認非技術債）、行數 1322/1146/224 已驗證、DefaultInternalPassword 為動態年份格式、MT_Roles.Name 無 UNIQUE 索引靠 SELECT COUNT、完整稽核快照覆蓋（2026-06-01 更新）
