...
- [Roles 頁面當前真實結構](project_roles_page_structure.md) — 5 個檔案（違反三檔規則）、3 個 Modal、SignalR 廣播、關鍵 Model 類別（2026-05-08）
- [稽核強化已實作](project_audit_enhancement_pending.md) — AuditLogJsonHelper.cs 已確認存在，RoleService 所有 CRUD 已整合 before/after 快照
- [公告模組兩層級權限尚未實作](project_announcement_permission_gap.md) — R-001 缺口：RolePermissionToggle 只有 bool IsEnabled，announcements 次層 radio 未做
